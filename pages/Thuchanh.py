...
def chuong3():
    ...
    if file_uploaded is not None:
        ...
        with col1:
            ...
            st.image(st.session_state.imgin, use_container_width=True)
        with col_mid:
            st.image("images/muiten.gif",use_container_width=True)
            st.image("images/muiten.gif",use_container_width=True)
...
def chuong4():
    ...
    if st.sidebar.button("DrawNotchRejectFilter"):
        ...
        st.sidebar.image(st.session_state.imgout,use_container_width=True,caption="DrawNotchRejectFilter")
...
def display_image(column, img, caption):
    column.image(img,caption,use_container_width=True)
