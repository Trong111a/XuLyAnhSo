...
if img_file_buffer is not None:
    ...
    with  col1:
        st.image(image, caption='Uploaded Image', use_container_width=True)  # Display the uploaded image larger
    if st.button('Predict'):
        ...
        with col2:
            st.image(img, caption='Detected Image',  use_container_width=True)  # Display the result image larger
