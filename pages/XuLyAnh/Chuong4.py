...
def RemoveMoire(imgin):
    ...
    for u in range(0, P):
        for v in range(0, Q):
            G[min(u, H.shape[0]-1), min(v, H.shape[1]-1), 0] = F[min(u, H.shape[0]-1), min(v, H.shape[1]-1), 0] * H[min(u, H.shape[0]-1), min(v, H.shape[1]-1)]
            G[min(u, H.shape[0]-1), min(v, H.shape[1]-1), 1] = F[min(u, H.shape[0]-1), min(v, H.shape[1]-1), 1] * H[min(u, H.shape[0]-1), min(v, H.shape[1]-1)]
